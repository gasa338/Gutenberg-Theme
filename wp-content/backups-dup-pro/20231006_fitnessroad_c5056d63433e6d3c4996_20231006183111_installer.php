...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20231006_fitnessroad_c5056d63433e6d3c4996_20231006183111_archive.zip';
    const ARCHIVE_SIZE       = '281111000';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'c5056d6-06183111';
    const SECONDARY_PACKAGE_HASH = 'bf10710-06183111';
    const VERSION            = '4.0.5';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.5==');
        $this->log('----------------------------------------------------');
